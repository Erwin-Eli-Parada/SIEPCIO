...
CREATE TABLE `nivel_educativo` (
  ...
  `nivel_edu` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cantidad` int DEFAULT NULL,
  `clave_mun` int DEFAULT NULL,
  PRIMARY KEY (`id_nivel_edu`),
  KEY `clave_mun_idx` (`clave_mun`),
  CONSTRAINT `clave_mun6` FOREIGN KEY (`clave_mun`) REFERENCES `municipio` (`clave_mun`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `nivel_educativo` VALUES (1,'Primaria',96,1),(2,'Secundaria',108,1),(3,'Posbasico',161,1),(4,'Primaria',5112,2),(5,'Secundaria',7186,2),(6,'Posbasico',8124,2);
