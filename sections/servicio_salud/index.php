...
<div class="section unica">
    <div class="table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th colspan="6">Servicios de salud de las personas que se autoadscriben indígenas</th>
                </tr>
                <tr>
            ...
            <tbody>
                <?php
                $sql = "SELECT nombre_municipio, servicio_salud, porcentaje FROM servicio_salud ss JOIN municipio m ON ss.clave_mun = m.clave_mun";
                try {
