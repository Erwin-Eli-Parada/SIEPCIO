...
if (isset($_POST['claveMunicipio'])) {
    ...
    if ($claveMunicipio === '') {
        $sql = "SELECT actividad_econom, sum(cantidad) as cantidad FROM act_economica ae JOIN municipio m ON ae.clave_mun = m.clave_mun WHERE m.tipo = 'Indigena' group by actividad_econom";
    } else {
